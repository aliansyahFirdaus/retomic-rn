...
import { TypescriptCompiler, resolveTypes, TypescriptTask, TypescriptConfigWriter } from "@teambit/typescript.typescript-compiler";
...
export class RetomicRnEnv extends ReactNativeEnv {
...
export default new RetomicRnEnv();
